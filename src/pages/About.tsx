  ...
  const whatMakesUnique = [
    {
      ...
      description: "Every 15 minutes, teams face a chance of elimination. It's not just about coding - it's about survival!"
    },
    {
      emoji: "📱",
      title: "QR Code Hunt",
    ...
    },
    {
      ...
      description: "Certificates, medals, and eternal glory await the champions!"
    },
    {
      emoji: "📝",
      title: "Handwritten Reference",
      description: "Bring up to 6 A4 sheets of handwritten notes - prepare like a pro!"
    }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-xl max-w-3xl mx-auto">
              A unique coding competition where programming skills meet survival instincts.
              Welcome to IKGPTU's most thrilling tech event!
            </p>
          </motion.div>
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-16">
            {eventHighlights.map((item, index) => (
              ...
              >
                <div className={`absolute -inset-1 bg-linear-to-r ${item.color} rounded-2xl opacity-30 group-hover:opacity-50 blur transition-opacity`} />
                <div className="relative bg-accent rounded-2xl p-6 border border-white/10 text-center">
                  <div className={`w-14 h-14 rounded-xl bg-linear-to-r ${item.color} flex items-center justify-center mx-auto mb-4 text-white`}>
                    {item.icon}
                  </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-gray-300 text-lg">
                <p>
                  Logic Loot is not just another coding competition - it's a <span className="text-orange-400 font-semibold">Coding Utsav</span> that combines the thrill of competitive programming with unique survival elements.
                </p>
                <p>
                  Form a team of 2-3 members, solve challenging problems to earn points, while navigating the exciting elimination system called <span className="text-red-400 font-semibold">"The Prop"</span>.
                </p>
                <p>
                  Hunt for QR codes across the campus for immunity, code under pressure, and emerge as the ultimate champion!
                </p>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Features that set Logic Loot apart from every other coding competition
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-accent/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-green-500/20">
              <div className="text-center mb-8">
                ...
                <h2 className="text-3xl md:text-4xl font-bold text-white">Eligibility</h2>
              </div>
