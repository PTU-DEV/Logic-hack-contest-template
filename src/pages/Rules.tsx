...
const Rules = () => {
  ...
  const verificationChecks = [
    { icon: <AlertTriangle className="w-5 h-5" />, text: "Malpractices detection", color: "text-yellow-400" },
    { icon: <Shield className="w-5 h-5" />, text: "Unfair advantages check", color: "text-orange-400" },
    { icon: <XCircle className="w-5 h-5" />, text: "AI-generated code scan", color: "text-red-400" }
  ];
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400 text-xl max-w-3xl mx-auto">
              Read carefully! These rules ensure fair play and an exciting experience for everyone.
            </p>
          </motion.div>
            ...
            <div className="relative">
              ...
              <div className="relative bg-red-500/10 border border-red-500/30 rounded-2xl p-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    <h3 className="text-red-400 font-bold text-lg mb-2">Important Notice</h3>
                    <p className="text-gray-300">
                      The organizing committee's decision is <strong className="text-white">final and binding</strong> in case of disputes.
                      The committee reserves the right to modify rules if required for fairness.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-6">
            {rules.map((rule, index) => (
              ...
              >
                <div className={`absolute -inset-1 bg-linear-to-r ${rule.color} rounded-2xl opacity-20 group-hover:opacity-30 blur transition-opacity`} />
                <div className="relative h-full bg-accent rounded-2xl p-6 border border-white/10">
                  <div className="flex items-center gap-3 mb-4">
                    <span className="text-3xl">{rule.icon}</span>
                    <h3 className="text-xl font-bold text-white">{rule.category}</h3>
                  </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-400">
              All submissions undergo thorough verification before results are announced
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="relative bg-accent/80 backdrop-blur-xl rounded-3xl p-8 md:p-12 border border-red-500/20">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div>
                  <h2 className="text-3xl md:text-4xl font-bold text-white">The Prop - Elimination Rules</h2>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="space-y-6">
                  <div className="p-4 bg-yellow-500/10 rounded-xl border border-yellow-500/20">
                    ...
                    <p className="text-gray-300">1/6 (16.67%) chance of elimination when selected</p>
                  </div>

                  <div className="p-4 bg-red-500/10 rounded-xl border border-red-500/20">
                    <h4 className="text-red-400 font-bold mb-2 flex items-center gap-2">
                      <AlertTriangle className="w-5 h-5" /> Second Half (90-180 minutes)
                    </h4>
                    <p className="text-gray-300">2/6 (33.33%) chance of elimination when selected</p>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <ol className="space-y-3 text-gray-300">
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0">1</span>
                      <span>Every 15 mins, 1-2 teams randomly selected</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0">2</span>
                      <span>Team Leader chooses who faces "The Prop"</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0">3</span>
                      <span>Selected member rolls for elimination</span>
                    </li>
                    <li className="flex items-start gap-3">
                      <span className="w-6 h-6 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm font-bold shrink-0">4</span>
              ...
              <div className="mt-8 p-4 bg-green-500/10 rounded-xl border border-green-500/20">
                ...
                <p className="text-gray-300">
                  Scan an active QR code to gain <strong className="text-white">10 minutes of immunity</strong> from "The Prop"!
                  QR codes are hidden across campus and activate randomly.
                </p>
              </div>
            </div>
          </motion.div>
